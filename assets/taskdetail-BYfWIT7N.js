import{C as p,c as o,aL as re,D as f,a as m,F as U,aW as X,d as E,u as M,b as Z,aX as te,e as G,f as H,g as q,aN as le,aO as ne,h as s,aY as se,aZ as ie,H as ae,a_ as de,Y as ce,T as be,Q as pe,U as ue,aJ as he,_ as ge,a$ as ve,n as F,x as me,o as K,i as Y,w as u,j as v,aB as g,k as C,b0 as w,ac as J,as as fe,aV as xe,aK as _e}from"./index-yCZGiaRh.js";import{_ as ye}from"./ContentLayout-Ca4xOEjL.js";function Q(e,r="default",n=[]){const{children:t}=e;if(t!==null&&typeof t=="object"&&!Array.isArray(t)){const a=t[r];if(typeof a=="function")return a()}return n}const ee="DESCRIPTION_ITEM_FLAG";function Ce(e){return typeof e=="object"&&e&&!Array.isArray(e)?e.type&&e.type[ee]:!1}const we=p([o("descriptions",{fontSize:"var(--n-font-size)"},[o("descriptions-separator",`
